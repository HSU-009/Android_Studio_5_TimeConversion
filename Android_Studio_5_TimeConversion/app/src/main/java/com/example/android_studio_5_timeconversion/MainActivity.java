package com.example.android_studio_5_timeconversion;
...
public class MainActivity extends AppCompatActivity {
    ...
    private View.OnClickListener the_Time = new View.OnClickListener() {
        ...
        public void onClick(View v) {
            ...
            EditText year = (EditText)findViewById(R.id.edittext1);
            EditText mouth = (EditText)findViewById(R.id.edittext2);
            EditText day = (EditText)findViewById(R.id.edittext3);
            EditText hour = (EditText)findViewById(R.id.edittext4);
            EditText minute = (EditText)findViewById(R.id.edittext5);
            EditText secord = (EditText)findViewById(R.id.edittext6);
